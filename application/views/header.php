...
<header>
    ...
    <div class="navbar-fixed">
        ...
        <nav class="mb-1 navbar navbar-expand-lg fixed-top navbar-dark">
            <!-- Navbar brand -->
            <img class="sizeLogo" src="<?= base_url('assets/img/logo.png'); ?>">
            <!-- Collapse button -->
            ...
            <div class="collapse navbar-collapse" id="basicExampleNav">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle colorItemNavBar ml-3" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Jeux</a>
                        <div class="dropdown-menu dropdown-primary mt-4" aria-labelledby="navbarDropdownMenuLink">
                            <div class="col-6">
                                <?php foreach ($categoryGame as $test) { ?>
                                    <a class="linkCategory"><?= $test->name ?></a>
                                <?php } ?>
                            </div>
                        </div>
                    </li>
                ...
                <ul class="navbar-nav ml-auto nav-flex-icons">
                    ...
                    <li class="nav-item dropdown mr-2">
                        <a class="nav-link dropdown-toggle colorItemNavBar" id="navbarDropdownMenuLink-4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
